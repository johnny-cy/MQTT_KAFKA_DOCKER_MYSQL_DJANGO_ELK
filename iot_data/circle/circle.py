...
from epa.area import (Taichung,
    ...
    Tainan, Kaohsiung, Pingtung, Changhua, Keelung, Taipei
    )
...
def main():
    ...
    controllers = [
        ...
        CircleController(area=Changhua, item="pm2_5"),
        CircleController(area=Keelung, item="pm2_5"),
        CircleController(area=Taipei, item="pm2_5"),
    ]
